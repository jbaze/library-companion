...
const en: Dict = {
  ...
  "admin.loan.optionalHint": "All fields are optional. They are shown here for desk-side confirmation only and are not stored.",
...
const mk: Dict = {
  ...
  // Meta
  "meta.rootTitle": "Атенеум — Каталог на универзитетската библиотека",
  ...
  "meta.catalogTitle": "Каталог — Универзитетска библиотека Атенеум",
  ...
  "admin.loan.optionalHint": "Сите полиња се незадолжителни. Се прикажуваат само за потврда на пултот и не се зачувуваат.",
